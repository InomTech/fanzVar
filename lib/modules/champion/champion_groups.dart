...
class ChampionGroups extends StatefulWidget {
  final championGroups, championDetails;
  const ChampionGroups(
      {required this.championGroups, required this.championDetails, super.key});

  @override
  State<ChampionGroups> createState() => _ChampionGroupsState();
}

class _ChampionGroupsState extends State<ChampionGroups> {
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
            itemCount: widget.championGroups.length,
            itemBuilder: (BuildContext ctx, int index) {
              return Padding(
                padding: const EdgeInsets.all(8.0),
                child: groupItem(widget.championGroups[index], width, height),
              );
            }),
      ),
    );
      ...
      children: [
        ...
        ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return clubItem(clubs[index]["ClubName"], clubs[index]["ClubID"],
                  index, height, width);
            }),
      ],
    );
