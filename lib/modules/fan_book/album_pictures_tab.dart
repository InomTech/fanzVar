...
class AlbumsPicturesTab extends StatefulWidget {
  final albumsList;
  const AlbumsPicturesTab({super.key, this.albumsList});

  @override
  State<AlbumsPicturesTab> createState() => _AlbumsPicturesTabState();
}

class _AlbumsPicturesTabState extends State<AlbumsPicturesTab> {
