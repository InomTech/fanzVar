...
class AlbumsVediosTab extends StatefulWidget {
  final albumsList;
  const AlbumsVediosTab({super.key, this.albumsList});

  @override
  State<AlbumsVediosTab> createState() => _AlbumsVediosTabState();
}

class _AlbumsVediosTabState extends State<AlbumsVediosTab> {
  // ignore: unused_field
